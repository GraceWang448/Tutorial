...
public class DriveConstants {
    ...
    public static PIDFCoefficients MOTOR_VELO_PID = new PIDFCoefficients(23, 0, 20, 13.28267);
    ...
    public static double GEAR_RATIO = (1/1)*(60/60.64); // output (wheel) speed / input (motor) speed
    public static double TRACK_WIDTH = 11.759; // in
    ...
    public static double MAX_ANG_VEL = Math.toRadians(255.72325537885877);
    public static double MAX_ANG_ACCEL = Math.toRadians(255.72325537885877);
